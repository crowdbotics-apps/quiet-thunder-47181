"""
Django settings for quiet_thunder_47181 project.
...
ROOT_URLCONF = 'quiet_thunder_47181.urls'
...
WSGI_APPLICATION = 'quiet_thunder_47181.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_thunder_47181 API",
    "DESCRIPTION": "API documentation for quiet_thunder_47181 App",
    "VERSION": "v1",
}
